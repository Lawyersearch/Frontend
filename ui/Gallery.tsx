...
const Gallery = ({
  ...
  const rightDisabled =
    !!contentRef.current && contentRef.current.scrollWidth + scroll <= width;
    ...
    <Stack direction="row">
      <IconButton
        ...
        sx={{
          ...
          ":hover": {
            background:
              "linear-gradient(90deg, rgba(100, 100, 100, 0.5), rgba(100, 100, 100, 0.01))",
          },
        }}
      >
      ...
      <IconButton
        ...
        sx={{
          ...
          ":hover": {
            background:
              "linear-gradient(270deg, rgba(100, 100, 100, 0.5), rgba(100, 100, 100, 0.01))",
          },
        }}
      >
