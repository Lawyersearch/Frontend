      ...
      <CardContent>
        <Stack justifyContent="center" alignItems="center">
          ...
          <Typography variant="body1">
            ...
            aspernatur atque debitis excepturi ipsa maiores, natus, possimus
            quidem rerum sed sunt totam ullam voluptatem voluptatibus,
            voluptatum! Aliquid commodi ipsam minima numquam. Accusantium
            adipisci, at cum cupiditate distinctio eius enim eum excepturi
            impedit in inventore iure magnam molestias necessitatibus odit
            possimus quae quam repudiandae tenetur, veniam. Architecto beatae
            cumque cupiditate debitis deleniti et iure neque non tempora vitae.
            Dolorem ex iste itaque iusto magnam maxime minima neque nesciunt,
            officia officiis placeat sapiente, suscipit tempora ullam ut? Beatae
            dolorum laudantium maxime odit officia provident qui quia quis
            ratione, recusandae repellendus voluptatibus. Facere!
          </Typography>
        </Stack>
      </CardContent>
    </Card>
